...
/* Fortran 90 compiler */
#define HYDRA_F90 "ifort -fpic -mcmodel=medium  "

/* Hydra release date information */
#define HYDRA_RELEASE_DATE "Thu Dec 20 14:27:22 CST 2012"

/* Hydra version information */
#define HYDRA_VERSION "3.0.1"
...
/* Define if getpagesize needs a declaration */
#define NEEDS_GETPAGESIZE_DECL 1
...
#define PACKAGE_STRING "Hydra 3.0.1"
